export default function HeroInfo({ nftPrice, maxMintAmount }) {
	return (
		<div className="mx-auto lg:w-3/4">
			<div>
				<h1 className="text-6xl font-bold text-center text-blue-600 font-flower">
					OCTO				<span className="text-blue-600 ">
					LAB
				</span>
				</h1>
				<h1 className="text-2xl font-bold text-center text-blue-600 font-flower">
				...
				<div className="space-y-4 text-2xl text-bold leading-6 text-gray-700 lg:text-4xl lg:leading-7">
					<ul className="list-disc">
						...
						<div className="flex items-start">
							<span className="flex items-center h-6 sm:h-7">🐙</span>
							<p className="ml-2 font-flower">
							From holders to holders, for the community RandoMice and Edgehogs. Each OctoLab allows its owner to be part of an exclusive community giving future different perks and experiences to its holders. <p>&nbsp;</p><a className="font-semibold text-blue-600"></a>
								<p>&nbsp;</p>
							</p>
						</div>						
					</ul>			
			...
			<div className="flex items-center space-x-10 py-4">
				...
				<div>
					<a href="https://etherscan.io/address/0xdC1E31A37734C7400Ca6C31c6aCc71A21e180d07#code" target="_blank" rel="noreferrer">
						<svg
							xmlns="http://www.w3.org/2000/svg"
